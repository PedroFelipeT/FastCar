 ...
 * @author Pedro
 */
public class RelatorioOs extends javax.swing.JFrame {

    /**
     * Creates new form RelatorioOs
     */
    public RelatorioOs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/equipe/fastcar/icons/sair-menu-2.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        List<AuxOsValores> relatorio = new ArrayList();
        OsDAO venda = new OsDAO();
        relatorio = venda.findAllRelatorio();
        DefaultTableModel dtm = (DefaultTableModel) tblOs.getModel();
        for (AuxOsValores a : relatorio) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioOs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioOs().setVisible(true);
            }
        });
    }
